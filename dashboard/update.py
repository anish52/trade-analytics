...
if __name__ == '__main__':
	...
	stock_price_widget = b.stock_price_plot_factory(stock_list, data_list[0])
	print('Done: stock_price_widget!')

	ti_widget = b.ti_plot_factory(data_list, ti_list, time_intervals, stock_list, cur_stock, cur_interval)
	print('Done: ti_widget!')

	heatmap_widget = b.get_heatmap_widget(df)
	print('Done: heatmap_widget!')

	index_stats_widget = b.get_index_stats_widget(sector_market_share, df)
	print('Done: index_stats_widget!')

	sector_wise_widget = b.get_sector_wise_widget(df)
	print('Done: sector_wise_widget!')

	cube_widget = b.get_cube_widget(df)
	print('Done: cube_widget!')

	prediction_widget = a.pred.plot_pred(pred_df)

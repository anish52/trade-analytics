...
class Heatmap:
    ...
    def get_heatmap(self, df):
        ...
        ax.annotate(text='META', xy=(68, 9), color='w', weight='semibold', fontsize=80, ha='center', va='center')
        ...
        #===============================================================================================================
        c = -3
        ax.annotate(text=str(df.loc['AAPL'][metric])+'%', xy=(22, 7), color=self.get_color('AAPL', df), weight='semibold', fontsize=100, ha='center', va='center')
        ax.annotate(text=str(df.loc['NVDA'][metric])+'%', xy=(34, 28.5), color=self.get_color('NVDA', df), weight='semibold', fontsize=100, ha='center', va='center')
        ax.annotate(text=str(df.loc['INTC'][metric])+'%', xy=(38, 14.3), color=self.get_color('INTC', df), weight='semibold', fontsize=100, ha='center', va='center')
        ax.annotate(text=str(df.loc['QCOM'][metric])+'%', xy=(38, 5.3), color=self.get_color('QCOM', df), weight='semibold', fontsize=90, ha='center', va='center')

        ax.annotate(text=str(df.loc['MSFT'][metric])+'%', xy=(62, 20), color=self.get_color('MSFT', df), weight='semibold', fontsize=100, ha='center', va='center')
        ax.annotate(text=str(df.loc['GOOGL'][metric])+'%', xy=(58, 7), color=self.get_color('GOOGL', df), weight='semibold', fontsize=90, ha='center', va='center')
        ax.annotate(text=str(df.loc['META'][metric])+'%', xy=(68, 7), color=self.get_color('META', df), weight='semibold', fontsize=80, ha='center', va='center')

        ax.annotate(text=str(df.loc['AMZN'][metric])+'%', xy=(86, 7), color=self.get_color('AMZN', df), weight='semibold', fontsize=80, ha='center', va='center')
        ax.annotate(text=str(df.loc['WMT'][metric])+'%', xy=(96, 7), color=self.get_color('WMT', df), weight='semibold', fontsize=80, ha='center', va='center')

        ax.annotate(text=str(df.loc['TSLA'][metric])+'%', xy=(86, 25), color=self.get_color('TSLA',df), weight='semibold', fontsize=80, ha='center', va='center')
        ax.annotate(text=str(df.loc['EA'][metric])+'%', xy=(96, 25), color=self.get_color('EA', df), weight='semibold', fontsize=80, ha='center', va='center')

        ax.annotate(text=str(df.loc['UNH'][metric])+'%', xy=(118, 22), color=self.get_color('UNH', df), weight='semibold', fontsize=100, ha='center', va='center')
        ax.annotate(text=str(df.loc['AZN'][metric])+'%', xy=(114, 7), color=self.get_color('AZN', df), weight='semibold', fontsize=90, ha='center', va='center')
        ax.annotate(text=str(df.loc['CVS'][metric])+'%', xy=(124, 7), color=self.get_color('CVS', df), weight='semibold', fontsize=80, ha='center', va='center')
